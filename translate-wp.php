...
<?php
    ...
    echo "<h2>" . __( 'WP Translate Plugin Options', 'mt_trans_domain' ) . "</h2>";
...
<p><?php _e("Main Language:", 'mt_trans_domain' ); ?> 
...
echo '<form action="http://translate.google.com/translate" method="get">
<select name="tl">
<option value="af">Afrikaans</option>
<option value="sq">Albanian</option>
<option value="ar">Arabic</option>
...
<option value="vi">Vietnamese</option>
<option value="yi">Yiddish</option>
</select><input type="hidden" name="sl" value="'.$widget_main.'" /><input type="hidden" name="u" value="'.$current_url.'" /><input type="submit" value="Submit" /></form>';

if ($supportplugin=="Yes") {
echo "<p style='font-size:x-small'>Translate Plugin made by <a href='http://wp-themes.ws'>Wordpress Themes</a></p>";
}
